...
<div class="container-fluid admin_menu">
    ...
    <ul class="nav nav-tabs" role="tablist">
        <li class="active"><a href="<?php echo u('lists')?>">栏目列表</a></li>
        <li><a href="<?php echo u('post')?>">保存栏目</a></li>
    </ul>
    <!-- TAB CONTENT -->
    <div class="tab-content">
        <div class="active tab-pane fade in" id="tab1">
            <table class="table table-hover">
                ...
                <tbody>
                    <?php if(is_array($data) || is_object($data)){foreach ($data as $v){?>
                        <tr>
                            <td><?php echo $v['cid']?></td>
                            <td><?php echo $v['_catname']?></td>
                            <td>
                                <a href="<?php echo u('post',['cid'=>$v['cid']])?>" class="btn btn-primary btn-xs">编辑</a>
                                <a href="javascript:if(confirm('确定删除吗？')) location.href='<?php echo u('remove',['cid'=>$v['cid']])?>';" class="btn btn-danger btn-xs">删除</a>
                            </td>
                        </tr>
                    <?php }}?>
                </tbody>
