...
<input type='hidden' name='csrf_token' value=''/>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="webname" value="<?php echo $model['webname']?>">
                    <span class="help-block">用{ {v('config.webname')} }来调用</span>

                </div>
                <div class="form-group">
                    <label for="exampleInputFile">网站关键字</label>
                    <textarea name="keywords" class="form-control" cols="30" rows="5"><?php echo $model['keywords']?></textarea>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label>icp备案号</label>
                    <input type="text" class="form-control" name="icp" value="<?php echo $model['icp']?>">
                </div>
                <div class="form-group">
                    <label>客服电话</label>
                ...
                <div class="form-group">
                    <label>微信公众号</label>
                    <input type="text" class="form-control" name="wechat" value="<?php echo $model['wechat']?>">
                </div>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="form-group">
                    <label>分页条数</label>
                    <input type="number" class="form-control" name="rows" value="<?php echo $model['rows']?>">
                </div>
            </div>
        </div>
